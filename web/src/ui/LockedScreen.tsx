  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Ссылка из прототипа. Раздел инцидентов появится на шаге 10 —
            до тех пор за ней честная заглушка, а не пустая лента. */}
        <span className="mono" style={{ fontSize: 12, color: '#63615B' }}>
          История инцидентов — шаг 10
        </span>
      </div>
    </div>
  )
...
// Красная полоса нарушения. В прототипе она говорит ещё про сгоревший стрик
// и сигнал Максиму — этого сервис пока не делает (шаги 10 и 13), и обещать
// нечем, поэтому здесь только то, что произошло на самом деле.
