  ...
  return (
    <Centered>
      <div style={{ textAlign: 'center', maxWidth: 520 }}>
        ...
        {/* Здесь висело «инцидент появится на шаге 10». Шаг прошёл, SR-3
            работает, и обещание превратилось в неправду наоборот: экран
            говорил «ещё не», когда уже «да». Строка убрана — то, что инцидент
            будет записан, сказано выше по экрану. */}
      </div>
    </Centered>
  )
}
